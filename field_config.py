    ...
    },
    {
        ...
        "fields": [
            {"placeholder": "publishDate", "label": "出版日期 (dd/mm/yyyy)",
                "source_key": "publication_date", "type": "date", "included_in_ai_prompt": True, "row_group": "pub_format"},
            ...
            {"placeholder": "bookBinding", "label": "裝幀",
                "source_key": "binding",          "type": "text", "included_in_ai_prompt": True, "row_group": "pub_format"},
            {"placeholder": "width",       "label": "長 (cm)",
                "source_key": "#trim_width",  "type": "text", "included_in_ai_prompt": True, "row_group": "dimensions"},
            {"placeholder": "height",      "label": "闊 (cm)",
                "source_key": "#trim_height", "type": "text", "included_in_ai_prompt": True, "row_group": "dimensions"},
            {"placeholder": "thickness",   "label": "高 (cm)",
                "source_key": "thickness",    "type": "text", "included_in_ai_prompt": True, "row_group": "dimensions"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"placeholder": "fromAge", "label": "從（歲）",
                "source_key": "", "type": "text", "row_group": "age_range"},
